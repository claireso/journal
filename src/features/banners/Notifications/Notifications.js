...
const BannerNotifications = () => {
  ...
  return (
    <Flash data-testid="flash-notifications" status="default" onClose={hideBanner}>
      <S.ButtonSubscribe onClick={subscribe}>{translations.bannerNotifications}</S.ButtonSubscribe>
    </Flash>
  )
}
