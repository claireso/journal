...
export const loadSubscriptions = (params) => ({
  types: [LOAD_SUBSCRIPTIONS_REQUEST, LOAD_SUBSCRIPTIONS_SUCCESS, LOAD_SUBSCRIPTIONS_ERROR],
  promise: () => api.get('/subscriptions', { params })
})

export const deleteSubscription = (id) => ({
  types: [DELETE_SUBSCRIPTION_REQUEST, DELETE_SUBSCRIPTION_SUCCESS, DELETE_SUBSCRIPTION_ERROR],
